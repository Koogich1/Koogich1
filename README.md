...
<p>
Привет, я FullStack разработчик с акцентом на Frontend. На данный момент активно ищу позицию Frontend/Fullstack разработчика. Уверенно владею своим стеком и готов решать сложные задачи. Открыт для новых возможностей и сотрудничества!
</p>
